...
class __$$InitialCopyWithImpl<T, $Res>
    extends _$ViewStateCopyWithImpl<T, $Res, _$Initial<T>>
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$ViewStateCopyWithImpl<T, $Res, _$Loading<T>>
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$ViewStateCopyWithImpl<T, $Res, _$Success<T>>
...
class __$$FailedCopyWithImpl<T, $Res>
    extends _$ViewStateCopyWithImpl<T, $Res, _$Failed<T>>
...
class _$Failed<T> implements Failed<T> {
  const _$Failed({required this.message});
  ...
  @override
  String toString() {
    return 'ViewState<$T>.failed(message: $message)';
  }
...
abstract class Failed<T> implements ViewState<T> {
  const factory Failed({required final String message}) = _$Failed<T>;
